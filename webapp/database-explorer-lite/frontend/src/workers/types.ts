...
export type ParsedMsg = { type: 'parsed'; ids: string[]; columns: Record<string, Float32Array | Int32Array | string[]>; meta: { numericColumns: string[]; categoricalColumns: string[] } }
